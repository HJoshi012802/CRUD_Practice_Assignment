...
export default function Updatedvendor(){
    const {id} =useParams();
    useEffect(()=>{
        axios.get(`https://crud-practice-assignment-bto7sjzeq.vercel.app/vendor/${id}`).then((res)=>{
  ...
  const [redirect,setRedirect]=useState(false);
    ...
    const updatevendor = ()=>{
      ...
      async function vendor(){
        ...
        const response= await fetch(`https://crud-practice-assignment-bto7sjzeq.vercel.app/updateVendor/${id}`,{
          method:'PUT',
